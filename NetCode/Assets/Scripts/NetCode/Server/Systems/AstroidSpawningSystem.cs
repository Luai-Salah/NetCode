    ...
    public partial class AsteroidSpawnSystem : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            for (int i = count; i < settings.NumberOfAsteroids; ++i)
            {
                ...
                Entity e = EntityManager.Instantiate(asteroidPrefab);
                ...
                EntityManager.SetSharedComponentData(e, new RigidBody2DComponent
                {
                    Body = m_PhysicsWorld.CreatePhysicsBody(e, new BodyDef
                    {
                        BodyType = b2BodyType.Dynamic,
                        GravityScale = 0,
                        StartLinearVelocity = randomVel
                    })
                });
            }
        }
